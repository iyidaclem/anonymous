            ...
            @endif
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="refered_by" class="col-md-4 col-form-label text-md-end">{{ __('Referer') }}</label>

                            <div class="col-md-6">
                                <input id="refered_by" type="text" class="form-control @error('refered_by') is-invalid @enderror" name="refered_by" value="{{ old('refered_by') }}" required autocomplete="refered_by">
